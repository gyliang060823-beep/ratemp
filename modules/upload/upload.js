...
export async function renderUpload(root, navigate) {
  ...
  root.innerHTML = `
    ...
    <form class="panel" id="upload-form">
      <div class="split">
        <div>
          <div class="field"><label>教师姓名</label><input name="name" required /></div>
          <div class="field"><label>学院 / 院系</label><input name="college" list="college-list" required /></div>
        ...
        <div>
          <div class="field"><label>研究方向</label><input name="research" /></div>
